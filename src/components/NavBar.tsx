  ...
  return (
    <div className=" ">
      <div className="h-12 w-fit bg-zinc-900   px-5 rounded-xl flex items-center gap-7 lg:opacity-50 lg:hover:opacity-100 transition duration-500 ease-out">
        ...
        <div className="group" onClick={scrollToEnd}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <span
            className="absolute left-[15rem] -translate-x-1/2   mt-3.5 px-2 py-1 bg-zinc-800 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out whitespace-nowrap"
            role="tooltip"
          >
            Contact
          </span>
