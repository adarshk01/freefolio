export function NavBar() {
  return (
    <div className=" ">
      <div className="h-12 w-fit bg-zinc-900   px-5 rounded-xl flex items-center gap-7">
        <div className="group">
          <svg
        ...
        <div className="group">
          ...
          <span
            className="absolute left-48 -translate-x-1/2   mt-3.5 px-2 py-1 bg-zinc-800 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out whitespace-nowrap"
            role="tooltip"
          >
            Contact
          </span>
