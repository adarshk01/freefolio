  ...
  return (
    <div className={` relative  lg:mt-0 mt-10 `}>
      <div>
        <h1 className=" ">
          <div>
            <div className="   text-white lg:text-[112px] text-5xl font-bold leading-none select-none lg:flex-none flex justify-center lg:justify-start ">
              SOFTWARE{" "}
            </div>
            <div className="  text-neutral-700  lg:text-[112px] text-5xl font-bold leading-none select-none lg:flex-none flex justify-center lg:justify-start ">
              ENGINEER
            </div>
          </div>
        </h1>

        <div className="mt-5 px-20 lg:px-0 lg:text-lg font-normal text-pretty lg:mr-24 text-greyText flex justify-center leading-relaxed  text-center lg:text-left">
          Passionate about creating intuitive and engaging user experiences.
          Specialize in transforming ideas into beautifully crafted products.
        </div>

        <div className="mt-10 flex lg:gap-16 gap-12 justify-center lg:flex-none lg:justify-start">
          ...
          <div className="h-fit w-96 bg-lime-400 p-5 rounded-xl mt-16 relative overflow-hidden  ">
            <div className="relative z-50">
              ...
              <div className="text-white mt-1   font-lg">
                Studying smart contracts and decentralized applications on
                Ethereum and Solana.
              </div>
            </div>
            <svg
